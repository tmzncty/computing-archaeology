...
The MIT CSAIL CTSS preservation page explicitly records how much modern access depends on the **Multics History Project**, especially scanning by **Roger Roach** and **Olin Sibert**, with important material from **Jerome Saltzer's** files and Bitsavers.
...
### Teletype and communications-document preservation

Model 33 history depends on surviving Teletype Corporation brochures, equipment documentation, DEC integration manuals, Bell System data-set documentation, and the people who scanned and mirrored them.

Those records preserve the computer terminal as a machine rather than a retrospective icon: motors, paper, paper tape, code levels, serial rate, and service options all remain visible.
